...
# --- НОВАЯ ФУНКЦИЯ: Расстояние Левенштейна ---
...
# --- Компоненты Трансформера на PyTorch (без изменений) ---
class MultiHeadAttention, PositionWiseFeedForward, PositionalEncoding, EncoderLayer, DecoderLayer, Transformer:
    # ... (Весь блок с классами PyTorch-модели остается точно таким же, как в вашем коде) ...
